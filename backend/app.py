...
class BTSWebsiteApp:
    ...
    def insert_sample_data(self):
        ...
        if cursor.fetchone()[0] == 0:
            members_data = [
                ('김남준', 'RM', '리더, 래퍼', '1994-09-12', 'BTS의 리더이자 메인 래퍼입니다.', '/static/images/rm.jpg'),
                ('김석진', 'Jin', '보컬, 비주얼', '1992-12-04', 'BTS의 보컬이자 비주얼을 담당합니다.', '/static/images/jin.jpg'),
                ('민윤기', 'Suga', '래퍼, 프로듀서', '1993-03-09', 'BTS의 래퍼이자 프로듀서입니다.', '/static/images/suga.jpg'),
                ('정호석', 'J-Hope', '래퍼, 댄서', '1994-02-18', 'BTS의 래퍼이자 메인 댄서입니다.', '/static/images/jhope.jpg'),
                ('박지민', 'Jimin', '보컬, 댄서', '1995-10-13', 'BTS의 보컬이자 리드 댄서입니다.', '/static/images/jimin.jpg'),
                ('김태형', 'V', '보컬, 비주얼', '1995-12-30', 'BTS의 보컬이자 비주얼을 담당합니다.', '/static/images/v.jpg'),
                ('전정국', 'Jungkook', '메인 보컬, 센터', '1997-09-01', 'BTS의 메인 보컬이자 센터입니다.', '/static/images/jungkook.jpg')
            ]
            
            for member in members_data:
                cursor.execute('''
                    INSERT INTO bts_members (name_korean, name_english, position, birth_date, description_korean, image_url)
                    VALUES (%s, %s, %s, %s, %s, %s)
                ''', member)
